...
export default function ContactForm() {
    ...
    return (
        <div className="w-max p-2.5 rounded-lg bg-container-soft-shadow/50  ">
            <form className="h-[360px] flex flex-col gap-3 aspect-video w-auto border border-container-stroke bg-bg rounded-lg p-3">
                <div className="flex gap-2.5">
                    <div className="flex flex-col flex-1 gap-1">
                        ...
                        <input
                            ...
                            className="h-9 focus:outline-1 -outline-offset-1 placeholder-opacity-50 text-text font-medium outline-text/50 pl-3 rounded-md bg-container-soft-shadow/50"
                            required
                        />
                    </div>
                    <div className="flex flex-col flex-1 gap-1">
                ...
                <div className="flex flex-col gap-1 grow relative">
                    ...
                    <textarea
                        id="message"
                        className="h-32 focus:outline-1 -outline-offset-1 pr-1  placeholder-opacity-50 grow text-text font-medium outline-text/50 pl-3 pt-2 rounded-t-md rounded-r-md bg-container-soft-shadow/50 resize-none"
                        required
                        name="message"
                    ...
                    >
                        <div
                            className={`bg-bg absolute rounded-b-md  text-container-soft-shadow/50  h-11 bottom-0 flex left-0 w-[calc(100%-9.375rem)]`}
                            id="textarea-fill"
                        >
                            {/* <div className="flex w-full">

                            </div> */}
                            <div className={`bg-container-soft-shadow/50 w-full rounded-b-md h-full ${isFocused ? ' border-b border-x border-text/50' : ''}`} />
                        ...
                        <button type="submit" aria-label="Send message" className="bg-text cursor-pointer flex items-center font-medium text-lg justify-center gap-1.5 text-bg w-36 h-9 rounded-md">
                            Send
                            <svg width="17" height="15" className="fill-current" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">

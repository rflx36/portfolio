...
export default function LandingContacts() {
    ...
    return (
        <div className="flex w-[calc(100%-4rem)] mx-8 gap-12 justify-center ">
            ...
            <button      {...cursorOnHoverCV} className="outline-none focus:text-accent-1 animate-[SlideUp_0.5s_cubic-bezier(0.75,0.63,0.13,0.83)_both_2.8s] flex gap-3 p-2 font-semibold text-xs ease-bezier-in duration-50 cursor-none items-center text-text/50 hover:text-accent-1">
            ...
            <button {...cursorOnHoverEmail} className="outline-none focus:text-accent-1 animate-[SlideUp_0.5s_cubic-bezier(0.75,0.63,0.13,0.83)_both_2.6s] flex gap-3 p-2  font-semibold text-xs ease-bezier-in duration-50 cursor-pointer items-center text-text/50 hover:text-accent-1">
